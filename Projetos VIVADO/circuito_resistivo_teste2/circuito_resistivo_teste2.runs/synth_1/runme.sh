...
HD_PWD='C:/Users/Renan/Documents/GitHub/Simulador_FPGA_UERJ/Projetos VIVADO/circuito_resistivo_teste2/circuito_resistivo_teste2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinus_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinus_gen.tcl
