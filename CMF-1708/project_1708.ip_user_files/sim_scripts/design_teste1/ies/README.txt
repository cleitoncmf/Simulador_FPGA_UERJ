...
#
# Generated by export_simulation on Mon Aug 17 15:12:55 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './design_teste1.sh' script.

./design_teste1.sh -reset_run
...
./design_teste1.sh -noclean_files

For more information on the script, please type './design_teste1.sh -help'.
