...
#
# Generated by export_simulation on Mon Aug 17 15:38:34 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './designteste2.sh' script.

./designteste2.sh -reset_run
...
./designteste2.sh -noclean_files

For more information on the script, please type './designteste2.sh -help'.
