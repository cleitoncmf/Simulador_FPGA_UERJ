...
#
# Generated by export_simulation on Tue Aug 25 23:23:44 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './design_RL1.sh' script.

./design_RL1.sh -reset_run
...
./design_RL1.sh -noclean_files

For more information on the script, please type './design_RL1.sh -help'.
