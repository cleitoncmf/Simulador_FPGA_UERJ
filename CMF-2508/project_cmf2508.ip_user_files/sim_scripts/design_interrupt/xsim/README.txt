...
#
# Generated by export_simulation on Tue Aug 25 17:03:39 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './design_interrupt.sh' script.

./design_interrupt.sh -reset_run
...
./design_interrupt.sh -noclean_files

For more information on the script, please type './design_interrupt.sh -help'.
