...
#
# Generated by export_simulation on Tue Aug 25 18:05:28 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './design_inturrupt2.sh' script.

./design_inturrupt2.sh -reset_run
...
./design_inturrupt2.sh -noclean_files

For more information on the script, please type './design_inturrupt2.sh -help'.
